...
User = pd.read_csv(path, sep=None, error_bad_lines=False, encoding='unicode_escape')
...
Book = pd.read_csv(path, sep=None, error_bad_lines=False, encoding='unicode_escape')
...
Rating = pd.read_csv(path, sep=None, error_bad_lines=False, encoding='unicode_escape')
